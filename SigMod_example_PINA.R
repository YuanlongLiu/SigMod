...
net_data=data.frame(net_matrix)
write.table(net_data[1:1000,1:1000], file="Pina_net_mattrix_1_1000.txt", row.names = TRUE,col.names = TRUE, sep="\t")
